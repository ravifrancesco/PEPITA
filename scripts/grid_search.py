...
if __name__ == '__main__':
    ...
    parser.add_argument('-res', '--resume', action='store_true', help='Resume gridsearch')
    ...
    parser.add_argument('-mom', '--momentum', nargs='*', type=float, default=[0.9], help="Momentum")
    ...
    parser.add_argument('-bstd', '--bstd', nargs='*', type=float, default=[0.05], help="B standard deviation")
