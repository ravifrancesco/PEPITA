...
def get_mnist(batchsize, val_split=0.2, augment=False, num_workers=8, normalize=False):
    r"""Return the training and testing dataloaders for MNIST
    ...
    normalizer = (transforms.Normalize((0.1307,), (0.3081,))) if normalize else ()
